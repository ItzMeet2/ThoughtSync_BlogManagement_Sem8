...
public class GoogleOAuthCallbackServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String defaultName = userInfo.has("name") ? userInfo.getString("name") : "Google User";
    ...
    private String getAccessToken(String code) throws Exception {
        ...
        String params = "code=" + URLEncoder.encode(code, StandardCharsets.UTF_8) +
                "&client_id=" + URLEncoder.encode(OAuthConstants.GOOGLE_CLIENT_ID, StandardCharsets.UTF_8) +
                "&client_secret=" + URLEncoder.encode(OAuthConstants.GOOGLE_CLIENT_SECRET, StandardCharsets.UTF_8) +
